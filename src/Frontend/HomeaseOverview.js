...
function HomeaseOverview() {
  ...
  return (
    <div
      ref={ref}
      class={`w-9/10 max-w-7xl h-800 bg-red-300 mx-auto md:mb-32 mt-32 transform-gpu ${
        visible && "scale-105"
      } transition-all duration-700 ease-in-out grid grid-cols-2 grid-rows-5 lg:grid-cols-6 lg:grid-rows-6 overflow-x-hidden`}
    >
      <div class="h-full col-start-1 col-span-1 row-start-2 lg:col-start-1 lg:col-span-2 lg:row-span-3 lg:row-start-4 lg:self-end lg:justify-self-start object-cover pl-6 z-10 overflow-hidden">
        <Fade bottom>
          <img
      ...
      <div class="h-full col-start-1 col-span-1 row-start-1 lg:col-start-1 lg:col-span-2 lg:row-span-3 lg:row-start-1 self-end justify-self-end object-cover pl-16 z-10 flex">
        <Fade left>
          <img
      ...
      <div class="w-9/10 p-6 ml-auto mt-auto col-start-1 row-start-3 col-span-2 row-span-2 lg:col-start-5 lg:col-span-2 lg:row-start-1 lg:row-span-4 lg:m-3 self-end justify-self-center z-10 border-t-2 border-white lg:border-0">
        <Fade right>
          <div class="w-9/10 p-6 ml-auto mt-auto col-start-1 row-start-3 col-span-2 row-span-2 lg:col-start-5 lg:col-span-2 lg:row-start-1 lg:row-span-4 lg:m-3 self-end justify-self-center z-10 rounded-none lg:rounded-md">
            ...
            <p class="text-gray-100 text-sm font-regular">
              Homease is an end to end real estate platform for tenants and
              brokers. We centralize the whole process, from finding your place,
              to putting your deposit down, and finally to paying rent.
            </p>

            <h5 class="text-sm font-semibold text-white mt-7 mb-4">
              The stack
            </h5>
